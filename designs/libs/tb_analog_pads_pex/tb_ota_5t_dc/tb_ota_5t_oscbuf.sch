...
C {devices/vsource.sym} -340 20 0 1 {name=V3 value="SIN(1.5 0.01 10k) AC 1" savecurrent=false}
C {devices/lab_wire.sym} -120 110 0 0 {name=p9 sig_type=std_logic lab=vin_p}
C {devices/code_shown.sym} 140 -470 0 0 {name=Simulation only_toplevel=false value="
.control
...
alter @V3[PULSE] = [ 0.65 2.8 1u $&tfr $&tfr $&ton $&tper ]
TRAN 5n 20u 0
plot vin_p out
write tb_ota_5t.raw
.endc
...
"}
C {devices/vsource.sym} -340 180 0 0 {name=V4 value=0 savecurrent=false}
...
C {libs/core_analog/ota_5t/ota_5t_oscbuff.sym} 0 0 0 0 {name=x1}
