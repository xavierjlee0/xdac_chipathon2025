...
C {devices/code_shown.sym} 1070 -1540 0 0 {name=Simulation only_toplevel=false value="
.control
.option gmin=1e-10
save all
...
C {devices/lab_wire.sym} 1110 -850 0 0 {name=p6 sig_type=std_logic lab=vdda}
C {devices/lab_wire.sym} 1120 -640 0 0 {name=p10 sig_type=std_logic lab=vssa}
