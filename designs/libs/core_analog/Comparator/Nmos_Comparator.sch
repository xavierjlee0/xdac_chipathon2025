...
N 490 -430 670 -430 {lab=Vss}
N 450 -610 450 -550 {lab=#net2}
N 490 -550 490 -490 {lab=#net2}
N 680 -630 680 -550 {lab=#net2}
N 550 -550 680 -550 {lab=#net2}
N 720 -600 820 -600 {lab=#net3}
N 770 -600 770 -490 {lab=#net3}
N 590 -640 590 -530 {lab=#net3}
N 590 -530 770 -530 {lab=#net3}
N 860 -630 930 -630 {lab=#net3}
N 890 -630 890 -560 {lab=#net3}
N 770 -560 890 -560 {lab=#net3}
...
N 480 -160 590 -160 {lab=Iref}
N 630 -430 630 -190 {lab=Vss}
N 490 -460 490 -130 {lab=Vss}
N 770 -460 770 -130 {lab=Vss}
C {symbols/nfet_03v3.sym} 210 -160 0 1 {name=M1
L=1u
W=4.55u
nf=1
m=1
...
C {symbols/nfet_03v3.sym} 610 -160 0 0 {name=M2
L=1u
W=18.2u
nf=1
m=1
