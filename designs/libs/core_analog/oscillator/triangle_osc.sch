...
N 260 -620 260 -580 {lab=#net3}
N 260 -360 260 -330 {lab=#net4}
...
N 780 -290 780 -250 {lab=vss}
N 1110 -290 1120 -290 {lab=vss}
N 1100 -260 1100 -250 {lab=vss}
N 990 -300 1060 -300 {lab=iref}
N 950 -260 950 -250 {lab=vss}
N 940 -290 940 -250 {lab=vss}
N 950 -600 950 -340 {lab=#net1}
N 250 -290 250 -250 {lab=vss}
N 260 -260 260 -250 {lab=vss}
N 790 -260 790 -250 {lab=vss}
N 790 -350 790 -340 {lab=iref}
N 950 -560 1020 -560 {lab=#net1}
N 830 -560 950 -560 {lab=#net1}
N 1100 -470 1100 -460 {lab=out}
N 1100 -380 1100 -340 {lab=#net5}
N 1030 -420 1060 -420 {lab=nq}
N 1030 -450 1030 -420 {lab=nq}
N 1030 -490 1030 -450 {lab=nq}
N 760 -450 770 -450 {lab=nq}
N 770 -450 1030 -450 {lab=nq}
N 1120 -420 1120 -410 {lab=vss}
N 1100 -420 1120 -420 {lab=vss}
N 1100 -390 1100 -380 {lab=#net5}
N 1100 -460 1100 -450 {lab=out}
...
C {libs/core_analog/unit_nmos/unit_nmos.sym} 830 -300 0 1 {name=x3 M=1}
C {libs/core_analog/unit_nmos/unit_nmos.sym} 990 -300 0 1 {name=x4 M=3}
C {libs/core_analog/unit_nmos/unit_nmos.sym} 1060 -300 0 0 {name=x5 M=3}
C {libs/core_analog/unit_nmos/unit_nmos.sym} 300 -300 0 1 {name=x2 M=1}
C {noconn.sym} 740 -430 2 0 {name=l2}
C {symbols/nfet_03v3.sym} 1080 -420 0 0 {name=M1
L=0.3u
W=3u
nf=1
m=1
