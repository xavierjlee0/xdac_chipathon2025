...
C {vsource.sym} 450 -765 0 0 {name=V3 value=2.6 savecurrent=false}
C {vsource.sym} 510 -765 0 0 {name=V4 value=0.7 savecurrent=false}
...
C {lab_wire.sym} 160 -550 0 0 {name=p4 sig_type=std_logic lab=vdd}
