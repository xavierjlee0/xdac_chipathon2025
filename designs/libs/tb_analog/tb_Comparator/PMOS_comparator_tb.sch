...
S {}
E {}
N 420 790 420 830 {lab=inn}
N 330 780 330 820 {lab=inp}
...
N 330 760 330 780 {lab=inp}
N 390 760 600 760 {lab=inp}
N 330 760 390 760 {lab=inp}
...
C {vsource.sym} 420 940 0 0 {name=VINN value=.3 savecurrent=false}
...
C {lab_wire.sym} 630 760 0 0 {name=p1 sig_type=std_logic lab=inp}
C {lab_wire.sym} 630 720 0 0 {name=p2 sig_type=std_logic lab=inn}
...
C {lab_wire.sym} 420 810 0 0 {name=p6 sig_type=std_logic lab=inn}
C {noconn.sym} 830 740 2 0 {name=l5}
C {lab_wire.sym} 810 740 0 0 {name=p5 sig_type=std_logic lab=out}
C {vsource.sym} 330 940 0 0 {name=VINP1 value=.8 savecurrent=false}
