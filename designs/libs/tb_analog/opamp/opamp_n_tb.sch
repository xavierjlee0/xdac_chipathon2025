...
N 880 -940 880 -750 {lab=out}
N 280 -760 600 -770 {lab=#net2}
...
C {devices/vsource.sym} 280 -820 0 1 {name=V3 value="SIN(0 0.01 10k) AC 0.01" savecurrent=false}
...
plot db(out*100) 180/pi*ph(out)
plot db(out*100) db(out_t*100)
TRAN 200n 200u 0
