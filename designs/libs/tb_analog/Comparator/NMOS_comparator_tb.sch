...
<<<<<<< HEAD:designs/libs/tb_analog/Comparator/NMOS_comparator_tb
...
>>>>>>> 67ff64427b03ce015c978369db06370de1bd3383:designs/libs/tb_analog/Comparator/NMOS_comparator_tb.sch
...
*alter @VINN[DC] = 2
alter @VINN[SIN] = [ 3.1 0.1 $&fnsig 0 0 ]

*alter @VINP[PULSE] = [ 0 3.3 1u $&tfr $&tfr $&ton $&tper 3 ]
alter @VINP[SIN] = [ 3.1 0.1 $&fsig 0 0 ]
=======
...
C {gnd.sym} 100 80 0 0 {name=l6 lab=GND}
=======
