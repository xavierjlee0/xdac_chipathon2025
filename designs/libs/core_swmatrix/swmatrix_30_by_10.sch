...
N -130 -10 0 -10 {lab=D_in,D_out_row[1:9]}
N -170 30 0 30 {lab=PHI_2}
N -170 10 0 10 {lab=PHI_1}
N 300 10 360 10 {lab=BUS[1:16]}
N 300 30 360 30 {lab=PIN[1:10]}
N 300 -10 360 -10 {lab=D_out_row[1:9],D_out}
N 100 -60 130 -60 {lab=VDDd}
N 130 -60 130 -40 {lab=VDDd}
N 180 -60 180 -40 {lab=VSSd}
N 180 -60 210 -60 {lab=VSSd}
C {iopin.sym} -260 130 0 0 {name=p1 lab=PIN[1:10]

}
C {iopin.sym} -260 100 0 0 {name=p2 lab=BUS[1:16]

}
C {libs/core_swmatrix/swmatrix_row_10.sym} 150 10 0 0 {name=xswmatrix_row[1:10]}
...
C {lab_wire.sym} 360 -10 0 1 {name=p6 sig_type=std_logic lab=D_out_row[1:9],D_out}
C {lab_wire.sym} -10 -10 0 0 {name=p7 sig_type=std_logic lab=D_in,D_out_row[1:9]}
C {lab_wire.sym} 360 10 0 1 {name=p8 sig_type=std_logic lab=BUS[1:16]}
C {lab_wire.sym} 360 30 0 1 {name=p9 sig_type=std_logic lab=PIN[1:10]
}
C {opin.sym} 540 -10 0 0 {name=p10 lab=D_out
}
C {title.sym} -142.5 255 0 0 {name=l2 author="Peter Kinget"}
C {iopin.sym} 210 -60 0 0 {name=p11 lab=VSSd}
C {iopin.sym} 100 -60 2 0 {name=p12 lab=VDDd}
