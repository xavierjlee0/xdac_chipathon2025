...
N 240 -200 270 -200 {lab=D_out_row[1:17],D_out}
N 240 -180 290 -180 {lab=VDDd}
N 240 -160 320 -160 {lab=BUS[1:16]}
N 240 -140 280 -140 {lab=PIN[1:18]}
N 240 -120 330 -120 {lab=VSSd}
N -140 -180 -60 -180 {lab=D_in,D_out_row[1:17]}
N -160 -160 -60 -160 {lab=PHI_1}
N -180 -140 -60 -140 {lab=PHI_2}
C {iopin.sym} -260 130 0 0 {name=p1 lab=PIN[1:18]
...
C {libs/core_swmatrix/Angel_row_block.sym} 90 -160 0 0 {name=xAngel_row_block[1:18]}
C {lab_wire.sym} -70 -200 0 0 {name=p14 sig_type=std_logic lab=EN}
C {lab_wire.sym} -90 -180 0 0 {name=p15 sig_type=std_logic lab=D_in,D_out_row[1:17]}
...
C {lab_wire.sym} 250 -200 0 1 {name=p18 sig_type=std_logic lab=D_out_row[1:17],D_out}
C {lab_wire.sym} 290 -160 0 1 {name=p19 sig_type=std_logic lab=BUS[1:16]}
C {lab_wire.sym} 280 -140 0 1 {name=p20 sig_type=std_logic lab=PIN[1:18]
}
